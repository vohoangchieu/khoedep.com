...
timber.cacheSelectors = function () {
    console.log("timber.cacheSelectors");
    timber.cache = {
        $html: $('html'),
        $body: $('body'),
...
timber.init = function () {
    ...
    timber.toTop();
    if (tada_newsletter)
        timber.ModalNewsletter();
};

timber.accessibleNav = function () {
    console.log("accessibleNav");
...
if ($(window).width() > 768) {
    ...
    timber.thumbGallerySlider = function () {
        console.log("thumbGallerySlider");
        if ($('.thumb__element').size() > 0) {
