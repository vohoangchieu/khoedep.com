...
<?php
                            foreach ($map_category[$category_info["url"]] as $key => $value) {
//                                var_dump($value["url"]);
?>                              <li><a href="<?php echo $value["map_url"]?>"><span><i class="fa fa-caret-right"></i> <?php echo $value["name"]?></span> <span class="collection-count"></span></a></li>
